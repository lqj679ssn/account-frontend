...
export interface ReCAPTCHA {
   ...
   * instead of a button.
   *
   * @param opt_widget_id Optional widget ID, defaults to the first widget created if
   *     unspecified.
   */
   ...
   *
   * @param container The HTML element to render the reCAPTCHA widget.  Specify
   *    either the ID of the container (string) or the DOM element itself.
   * @param parameters An object containing parameters as key=value pairs, for example,
